<template>
  <div>
            ...
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="toggleCheckAll">
                  <span class="checkbox-btn item-check-btn" :class="{'check': checkAllFlag == '1'}">
    ...
    <modal :md-show="modalConfirm" @close="modalConfirm = false">
      <p slot="msg">Are you sure to delete this item ?</p>
      <div slot="btn-group">
        <a class="btn btn-m" href="javascript:;" @click="delCart">sure</a>        
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      toggleCheckAll() {
        let flag = this.checkAllFlag == '1' ? '0' : '1';
        this.cartList.forEach(item => {
          item.checked = flag;
        })
